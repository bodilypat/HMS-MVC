...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3"><h2 class="admin-heading">Update Book</h2></div>
            </div>
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <form class="yourForm" action="{{ route('book.update', $book->id)}}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input tyype="text" class="form-control @error('name') isinvalid @enderror" placeholder="Book Name" name="name"
                                   value="{{ $book->name }}" >
                            @error('name')
